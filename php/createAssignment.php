...
echo $assignmentName . $assignmentDueDate . $assignmentDescription . $assignmentType . $classID . $userID;
...
$newAssignment = mysqli_query($con, "INSERT INTO `assignments` (ID, classID, creatorID, name, dueDate, type, description)
 VALUES ('', '$classID', '$userID', '$assignmentName', '$assignmentDueDate', '$assignmentType', '$assignmentDescription')");
...
header("Location: ../viewClass.php?class=".$classID."&s=2");
